...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link ">
        ...
        <?php
            $mas = [
                [
                    "avatars" => "img/demo/avatars/avatar-b.png",
                    "name" => "Oliver Kopyov",
                    "value" => "IT Director, Gotbootstrap Inc",
                    "email" => "oliver.kopyov@smartadminwebapp.com",
                    "number" => "+1 317-456-2564",
                    "adrres" => "15 Charist St, Detroit, MI, 48212, USA",
                ],
                [
                    "avatars" => "img/demo/avatars/avatar-k.png",
                    "name" => "Sesha Gray",
                    "value" => "Project Manager, Gotbootstrap Inc",
                ...
                [
                    ...
                    "value" => "Human Resources, Gotbootstrap Inc",
        ...
        <main id="js-page-content" role="main" class="page-content">
            ...
            <div class="row js-list-filter" id="js-contacts">
                ...
                <?php foreach ($mas as $key => $value) {?>
                    ...
                    <h1><?php echo $value["name"]; ?></h1><hr><hr>
                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url(<?php echo $value["avatars"]; ?>); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    ...
                                    <span class="text-truncate text-truncate-xl"><?php echo $value["value"]; ?>.</span>
                                </div>
