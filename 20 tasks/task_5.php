...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link ">
        <?php
            ...
            $heading1 = "Sunny A. (UI/UX Expert)";
            $heading2 = "Jos K. (ASP.NET Developer)";
            $heading3 = "Jovanni L. (PHP Developer)";
            $heading4 = "Roberto R. (Rails Developer)";

            $small1 = "Lead Author";
            $small2 = "Partner &amp; Contributor";
            $small3 = "Partner &amp; Contributor";
            $small4 = "Partner &amp; Contributor";
        ?>
